...
- e99d871: feat: export Resend route schemas from a public subpath.
- 5ca757e: feat: expose outbound email queueing as a fragment service with `Idempotency-Key` deduplication.
...
- 4d3b58a: fix: align Resend webhook registration and receive endpoint paths
- 1ba7198: feat: add inbound email and thread routes with backoffice support
- bda2e27: feat: add Resend domain list and detail routes
