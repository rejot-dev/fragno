...
- 5660bc1: feat: add GitHub user OAuth routes for restoring installations.
- a3aa2c8: feat: add repository-scoped read access tokens for linked GitHub repositories.
- 25f27fe: feat: expose GitHub webhook metadata to registered webhook handlers.
- fc32030: fix: refresh installation metadata when syncing GitHub installations.
