    ...
    <footer className="bg-fd-card text-fd-secondary-foreground mt-auto border-t px-8 py-8 sm:py-12">
      <div className="mx-auto flex max-w-4xl flex-col-reverse items-center gap-4 text-sm text-[var(--color-gray)] sm:flex-row sm:justify-between">
        ...
        <div className="flex items-center">
          <a href="https://rejot.dev" className="hover:text-[var(--color-text)]">
            <ReJotWireframeLogo className="size-10" />
          </a>
        </div>
        <div className="flex gap-4">
          <a href="https://github.com/rejot-dev" className="hover:text-[var(--color-text)]">
            GitHub
          </a>
          <a href="https://x.com/ReJotSync" className="hover:text-[var(--color-text)]">
            X
          </a>
        </div>
      </div>
