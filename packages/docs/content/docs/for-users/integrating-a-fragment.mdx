...
Integrating a Fragment into your project is a straightforward process. This page contains the
...
<Cards>
  <Card
    title="Installing a Fragment as a User"
    href="/docs#installing-a-fragment-as-a-user"
    description="Learn how to integrate a Fragment into your codebase."
  />
</Cards>

There are two main integration points for a Fragment: server-side & client-side. In the reference
documentation below you'll find examples for each framework.
