...
only imports the correct bundle. Make sure you don't package any peerDependencies in your frontend
bundle by using the `external` config option in tsdown or equivalent.
