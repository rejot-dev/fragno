...
import type { TypedUnitOfWork } from "./unit-of-work/unit-of-work";
...
describe("query type tests", () => {
  ...
  describe("create (TypedUnitOfWork)", () => {
    it("should require non-nullable columns and allow omitting nullable columns", () => {
      const _uow = {} as TypedUnitOfWork<TestSchema>;

      type Params = Parameters<typeof _uow.create<"users">>[1];
    ...
    it("should return the created ID", () => {
      const _uow = {} as TypedUnitOfWork<TestSchema>;
      type Result = ReturnType<typeof _uow.create<"users">>;
    ...
    it("should handle posts table correctly", () => {
      ...
      type Params = Parameters<typeof _uow.create<"posts">>[1];
  ...
  describe("complex scenarios", () => {
    it("should handle multiple table operations with correct types", () => {
      ...
      type UserResult = ReturnType<typeof _uow.create<"users">>;
      expectTypeOf<UserResult>().toEqualTypeOf<FragnoId>();

      // Create post return type
      type PostResult = ReturnType<typeof _uow.create<"posts">>;
