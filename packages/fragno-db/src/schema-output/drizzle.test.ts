...
describe("generateDrizzleSchema", () => {
  ...
  describe("default values", () => {
    it("should handle runtime default values", () => {
      ...
      expect(generated).toMatchInlineSnapshot(`
        "import { pgSchema, varchar, timestamp, bigserial, integer, text, index } from "drizzle-orm/pg-core"
        import { createId } from "@fragno-dev/db/id"
  ...
  describe("binary columns", () => {
    it("should generate custom type for binary columns", () => {
      ...
      expect(generated).toMatchInlineSnapshot(`
        "import { pgSchema, varchar, customType, bigserial, integer, text, index } from "drizzle-orm/pg-core"
        import { createId } from "@fragno-dev/db/id"
  ...
  describe("many relations", () => {
    ...
    it("should generate PostgreSQL schema with many relations", () => {
      ...
      expect(generated).toMatchInlineSnapshot(`
        "import { pgSchema, varchar, text, bigserial, integer, index, bigint, foreignKey } from "drizzle-orm/pg-core"
        import { createId } from "@fragno-dev/db/id"
        import { relations } from "drizzle-orm"
    ...
    it("should generate MySQL schema with many relations", () => {
      ...
      expect(generated).toMatchInlineSnapshot(`
        "import { mysqlTable, varchar, text, bigint, int, index, foreignKey } from "drizzle-orm/mysql-core"
        import { createId } from "@fragno-dev/db/id"
        import { relations } from "drizzle-orm"
    ...
    it("should handle table with only many relations (no foreign keys)", () => {
      ...
      expect(generated).toMatchInlineSnapshot(`
        "import { pgSchema, varchar, text, bigserial, integer, index, bigint } from "drizzle-orm/pg-core"
        import { createId } from "@fragno-dev/db/id"
        import { relations } from "drizzle-orm"
