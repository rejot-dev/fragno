...
- c39b97b: feat: type access token principals with their configured session context.
- cdc8797: feat: allow beforeCreateUser hooks to set the initial user role.
- ba9fde7: feat: add controlled service mutations for seeded users and organizations.
- c56fa46: feat: expose current user authority facts for external authorization.
...
- 1b92168: fix: preserve concrete auth route schemas in server callers
- e63dc7d: fix: tighten organization permissions and cursor validation.
- a9b41ca: fix: scope default auto-created organization slugs by user.
...
- 81815ae: feat: expose the complete durable hook context to auth callbacks.
