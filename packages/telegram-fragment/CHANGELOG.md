...
- 35850b8: Expose durable hook context from Telegram, OTP, and GitHub webhook callbacks so integrators can use
  hook ids as event ids.
- 6c55570: fix: resolve environment-neutral runtime modules through one canonical build.
- 3f9d1bb: fix: normalize database constraint errors for duplicate handling.
- 082a806: feat: export Telegram runtime type schemas and tighten Telegram payload validation.
- 231b029: feat: allow injecting a custom Telegram API implementation.
- f856070: Ensure all non-private packages include repository metadata in their `package.json` entries.
- d8966b8: feat: expose durable hook propagation context to Telegram callbacks.
...
- 2c528f4: feat: support telegram attachment downloads in automation flows
- 5764ab5: feat: persist outgoing telegram messages
