...
Revalidated (2026-01-19): Prisma adapter SQLite/PGLite tests (added SQLite UOW findWithCursor
coverage) (`pnpm -C packages/fragno-db test -- prisma-adapter`), repository lint (`pnpm lint`),
repository types check (`pnpm turbo run types:check`).

Revalidated (2026-01-19): Prisma adapter SQLite/PGLite tests (spec review run)
(`pnpm -C packages/fragno-db test -- prisma-adapter`), repository lint (`pnpm lint`), repository
types check (`pnpm turbo run types:check`).

Revalidated (2026-01-19): Prisma adapter SQLite/PGLite tests (SQLite/PGLite focus run)
(`pnpm -C packages/fragno-db test -- prisma-adapter`), repository lint (`pnpm lint`), repository
types check (`pnpm turbo run types:check`).
...
Revalidated (2026-01-19): Prisma schema generation relation naming coverage (SQLite/PGLite), Prisma
...
Revalidated (2026-01-19): Added SQLite prisma ISO date storage test; Prisma adapter SQLite/PGLite
tests (`pnpm -C packages/fragno-db test -- prisma-adapter`), repository lint (`pnpm lint`),
repository types check (`pnpm turbo run types:check`).
...
Revalidated (2026-01-19): Prisma adapter SQLite/PGLite tests
(`pnpm -C packages/fragno-db test -- prisma-adapter`).
...
Revalidated (2026-01-19): Prisma adapter SQLite/PGLite tests
(`pnpm -C packages/fragno-db test -- prisma-adapter`), repository lint (`pnpm lint`), repository
types check (`pnpm turbo run types:check`); updated Prisma docs with SQLite BigInt safety guidance.
...
Revalidated (2026-01-19): Added Prisma PGLite version conflict coverage; Prisma adapter
SQLite/PGLite tests (`pnpm -C packages/fragno-db test -- prisma-adapter`), repository lint
(`pnpm lint`), repository types check (`pnpm turbo run types:check`).
