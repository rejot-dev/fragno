...
Implement spec-defined work using FP issues as the plan of record. The spec defines scope and
acceptance criteria; FP issues define tasks, dependencies, and status.
