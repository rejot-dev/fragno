...
- ce8a991: fix: make repeated OTP confirmations idempotent.
- 46ab999: feat: replace positional OTP issuance with request objects and explicit lifecycle result states.
- f50bd58: fix: reject stale OTP confirmation replay after newer challenges are issued.
- f856070: Ensure all non-private packages include repository metadata in their `package.json` entries.
- 44bda1f: feat: expose durable hook propagation context to OTP callbacks.
...
- 25f8d3e: feat: add confirmation and identity-link payloads for OTP events
- 57c2691: feat: add typed OTP fragment with hooks
