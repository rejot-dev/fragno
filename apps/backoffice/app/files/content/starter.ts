...
export const STARTER_WORKSPACE_ROOT_DESCRIPTION =
  "Starter workspace files, including filesystem-backed automation manifests plus bash/codemode scripts, layered under an optional persistent Upload-backed override. Bootstrap uses if-missing semantics so starter content remains the fallback source of truth.";
