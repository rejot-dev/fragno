  ...
  test("project, sandbox, connection, and configured capability events are represented in the catalog", () => {
    ...
    expect(events).toEqual(
      expect.arrayContaining([
        ...
        { capabilityId: "automations", source: "scheduler", eventType: "schedule.triggered" },
        ...
        { capabilityId: "github", source: "github", eventType: "issues.opened" },
        { capabilityId: "github", source: "github", eventType: "issue_comment.created" },
        { capabilityId: "github", source: "github", eventType: "pull_request.opened" },
        { capabilityId: "github", source: "github", eventType: "pull_request.synchronize" },
        { capabilityId: "github", source: "github", eventType: "push" },
