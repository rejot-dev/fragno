...
- Works across multiple frameworks (React, Vue, Svelte, Solid, [etc.](./reference/frameworks))
...
- **End-to-end type safety**: routes are typed using Standard Schema and client-side hooks are fully
  type-safe
- **Built-in frontend state management**: reactive stores with caching built in (TanStack
  Query-style), using [Nano Stores](https://github.com/nanostores/nanostores)
...
[For Library Authors](./docs/fragno/for-library-authors/getting-started) section to learn how to
build your own Fragno fragments.
