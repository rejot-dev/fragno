...
- Generate and run migrations with the [Fragno CLI](/docs/reference/cli).
- Add fragment routes to your server framework (see
  [Integrating a Fragment](/docs/fragno/for-users/integrating-a-fragment)).
