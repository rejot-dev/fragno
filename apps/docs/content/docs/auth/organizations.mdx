...
All organization routes require authentication. Use the ambient `fragno_auth` cookie or an
...
| `POST` | `/organizations/active` | Set the active organization for the current credential context. |
