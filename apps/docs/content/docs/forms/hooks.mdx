...
<TypeTable
  type={{
    ...
    title: { description: "Form title", type: "string" },
    description: { description: "Form description", type: "string | null" },
    slug: { description: "URL-friendly identifier", type: "string" },
    status: { description: "Form status", type: '"draft" | "open" | "closed" | "static"' },
    dataSchema: { description: "JSON Schema for validation", type: "Record<string, unknown>" },
    uiSchema: { description: "JSONForms UI Schema", type: "Record<string, unknown> | undefined" },
    version: { description: "Schema version number", type: "number" },
    createdAt: { description: "Creation timestamp", type: "Date" },
    updatedAt: { description: "Last update timestamp", type: "Date" },
  }}
/>
...
<TypeTable
  type={{
    id: { description: "Unique identifier", type: "string" },
    formId: { description: "Associated form ID", type: "string | null" },
    formVersion: { description: "Form version at submission time", type: "number" },
    data: { description: "Submitted form data", type: "Record<string, unknown>" },
    submittedAt: { description: "Submission timestamp", type: "Date" },
    ip: { description: "Submitter IP address", type: "string | null" },
    userAgent: { description: "Submitter user agent", type: "string | null" },
  }}
/>
