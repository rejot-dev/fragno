...
<AutoTypeTable path="packages/stripe/src/types.ts" name="StripeEntityData" />
...
The fragment exposes a couple of service functions that can be used server-side to query data from
