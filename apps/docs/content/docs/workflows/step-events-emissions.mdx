...
description: Publish live step output, receive durable events, and inspect prior emissions.
icon: Radio
---
...
## Inspect persisted emissions

The instance history route returns emissions that are still persisted at read time. Because
