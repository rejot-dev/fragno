...
```bash
npm install -g @fragno-apps/fragno-wf
```

Or run it without installing:

```bash
npx @fragno-apps/fragno-wf --help
```
...
fragno-wf instances list -b https://host.example.com/api/workflows -w approvals --status active
