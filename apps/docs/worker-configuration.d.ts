/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: 40f36b9dc32dc08941ac97697749b19d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITEKEY" | "TURNSTILE_SECRET_KEY" | "RESEND_API_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
declare module "*.sql" {
	const value: string;
