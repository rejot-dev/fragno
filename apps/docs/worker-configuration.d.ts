/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv --env-file .dev.vars.example` (hash: 5a44b7d5e67887b050ecb830f43ef70e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITEKEY" | "TURNSTILE_SECRET_KEY" | "RESEND_API_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "CLOUDFLARE_WORKERS_ACCOUNT_ID" | "CLOUDFLARE_WORKERS_API_TOKEN" | "DOCS_PUBLIC_BASE_URL" | "GITHUB_APP_ID" | "GITHUB_APP_SLUG" | "GITHUB_APP_CLIENT_ID" | "GITHUB_APP_CLIENT_SECRET" | "GITHUB_APP_WEBHOOK_SECRET" | "GITHUB_APP_PRIVATE_KEY">> {}
}
declare module "*.sql" {
	const value: string;
