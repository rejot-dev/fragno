/* eslint-disable */
<<<<<<< HEAD
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv --env-file .dev.vars.example` (hash: 4b8e8f0c28a38474260a6c96f968c25e)
=======
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv --env-file .dev.vars.example` (hash: b3d7d4ad4b69901fafae52a329761d55)
>>>>>>> 39574bc4 (feat(docs): create automations durable object for workflows fragment)
...
<<<<<<< HEAD
		durableNamespaces: "MailingList" | "Forms" | "Auth" | "Telegram" | "Resend" | "Sandbox" | "SandboxRegistry" | "GitHub" | "GitHubWebhookRouter" | "Upload" | "CloudflareWorkers" | "Pi" | "Otp";
=======
		durableNamespaces: "MailingList" | "Forms" | "Auth" | "Telegram" | "Resend" | "Sandbox" | "SandboxRegistry" | "GitHub" | "GitHubWebhookRouter" | "Upload" | "CloudflareWorkers" | "Pi" | "Automations";
>>>>>>> 39574bc4 (feat(docs): create automations durable object for workflows fragment)
	}
	interface Env {
		...
		TELEGRAM: DurableObjectNamespace<import("./workers/app").Telegram>;
		RESEND: DurableObjectNamespace<import("./workers/app").Resend>;
		OTP: DurableObjectNamespace<import("./workers/app").Otp>;
		UPLOAD: DurableObjectNamespace<import("./workers/app").Upload>;
		CLOUDFLARE_WORKERS: DurableObjectNamespace<import("./workers/app").CloudflareWorkers>;
		...
		PI: DurableObjectNamespace<import("./workers/app").Pi>;
		AUTOMATIONS: DurableObjectNamespace<import("./workers/app").Automations>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITEKEY" | "TURNSTILE_SECRET_KEY" | "RESEND_API_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_APP_ID" | "GITHUB_APP_SLUG" | "GITHUB_APP_CLIENT_ID" | "GITHUB_APP_CLIENT_SECRET" | "GITHUB_APP_WEBHOOK_SECRET" | "GITHUB_APP_PRIVATE_KEY">> {}
}
declare module "*.sql" {
	const value: string;
