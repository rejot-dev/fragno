/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: 224ccb98f9a9f94babdd6347f61ddb06)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITEKEY" | "TURNSTILE_SECRET_KEY">> {}
}
declare module "*.sql" {
	const value: string;
