/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv --env-file .dev.vars.example` (hash: aa7244300bc4e4e59aaf9e834129474b)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITEKEY" | "TURNSTILE_SECRET_KEY" | "RESEND_API_KEY">> {}
}
declare module "*.sql" {
	const value: string;
