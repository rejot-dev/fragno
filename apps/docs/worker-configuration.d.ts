/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.docs.jsonc -c wrangler.backoffice.jsonc -c wrangler.jsonc --env-interface CloudflareEnv --env-file .dev.vars.example` (hash: cb431d2ba813d778b651bcefaaaea85e)
// Runtime types generated with workerd@1.20260312.1 2025-09-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/docs");
		durableNamespaces: "MailingList" | "Forms" | "Auth" | "Telegram" | "Resend" | "Sandbox" | "SandboxRegistry" | "GitHub" | "GitHubWebhookRouter" | "Upload" | "CloudflareWorkers" | "Pi" | "Otp" | "Automations";
	}
	interface Env {
		...
		MAILING_LIST: DurableObjectNamespace<import("./workers/docs").MailingList>;
		FORMS: DurableObjectNamespace<import("./workers/docs").Forms>;
		AUTH: DurableObjectNamespace<import("./workers/docs").Auth>;
		TELEGRAM: DurableObjectNamespace<import("./workers/docs").Telegram>;
		RESEND: DurableObjectNamespace<import("./workers/docs").Resend>;
		OTP: DurableObjectNamespace<import("./workers/docs").Otp>;
		UPLOAD: DurableObjectNamespace<import("./workers/docs").Upload>;
		CLOUDFLARE_WORKERS: DurableObjectNamespace<import("./workers/docs").CloudflareWorkers>;
		SANDBOX: DurableObjectNamespace<import("./workers/docs").Sandbox>;
		SANDBOX_REGISTRY: DurableObjectNamespace<import("./workers/docs").SandboxRegistry>;
		GITHUB: DurableObjectNamespace<import("./workers/docs").GitHub>;
		GITHUB_WEBHOOK_ROUTER: DurableObjectNamespace<import("./workers/docs").GitHubWebhookRouter>;
		PI: DurableObjectNamespace<import("./workers/docs").Pi>;
		AUTOMATIONS: DurableObjectNamespace<import("./workers/docs").Automations>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITEKEY" | "TURNSTILE_SECRET_KEY" | "RESEND_API_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "DOCS_PUBLIC_BASE_URL" | "GITHUB_APP_ID" | "GITHUB_APP_SLUG" | "GITHUB_APP_CLIENT_ID" | "GITHUB_APP_CLIENT_SECRET" | "GITHUB_APP_WEBHOOK_SECRET" | "GITHUB_APP_PRIVATE_KEY">> {}
}
declare module "*.sql" {
	const value: string;
