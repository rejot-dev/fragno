...
type ShowcaseItem = {
  id: "stripe" | "forms" | "auth" | "workflows" | "upload";
  label: string;
...
const showcaseItems: ShowcaseItem[] = [
  {
    ...
    details: ["Secure email and password", "Simple role management"],
    href: "/docs/auth",
    cta: "Auth Docs",
  ...
  },
  {
    ...
    details: [
      "File + upload records with statuses and metadata.",
      "Direct, multipart, and server-streamed uploads.",
      "S3/R2 and filesystem storage adapters.",
    ],
    href: "/docs/upload",
    cta: "Upload Docs",
