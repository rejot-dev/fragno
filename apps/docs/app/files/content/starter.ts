...
3. When Upload is configured, persistent files can override these starter files at the same path.
...
export const STARTER_WORKSPACE_ROOT_DESCRIPTION =
  "Starter workspace files layered under an optional persistent Upload-backed override. Bootstrap uses if-missing semantics so starter content remains the fallback source of truth.";
