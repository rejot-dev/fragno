  ...
  return (
    <section className="space-y-18 w-full max-w-5xl">
      ...
      <div className="flex items-end justify-center">
        <Cake variant="cake-full" className="size-48 md:size-64" />
        <Cake variant="cake-crumbs" className="mr-2 size-12 md:size-16" />
        <Cake variant="cake-slice" className="size-32 translate-y-4 md:size-44 md:translate-y-6" />
      </div>
    </section>
  );
}
