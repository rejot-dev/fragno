        ...
        title: (
          <div className="flex items-center gap-2">
            <span className="relative">
              <span
                aria-hidden
                className="pointer-events-none absolute inset-0 -z-10 rounded-full bg-linear-to-br from-blue-500/25 via-sky-400/20 to-purple-500/25 blur-md"
              />
              <FragnoCircle className="size-8" />
            </span>
            <span className="text-[15px] font-semibold tracking-tight">Fragno</span>
          </div>
        ),
      }}
      links={[
          ...
          children: (
            <div className="flex items-center gap-2 pe-2 max-sm:hidden">
              <a
                ...
                aria-label="GitHub"
                className="text-fd-foreground/70 hover:bg-fd-accent/55 hover:text-fd-foreground focus-visible:ring-fd-ring inline-flex h-10 w-10 items-center justify-center rounded-full transition-colors focus-visible:ring-2 focus-visible:outline-none"
              >
